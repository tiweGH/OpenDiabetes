...
import static de.opendiabetes.vault.container.VaultEntryType.BOLUS_NORMAL;
import static de.opendiabetes.vault.container.VaultEntryType.BOLUS_SQARE;
import static de.opendiabetes.vault.container.VaultEntryType.EXERCISE_MANUAL;
import static de.opendiabetes.vault.container.VaultEntryType.GLUCOSE_CGM;
import static de.opendiabetes.vault.container.VaultEntryType.MEAL_MANUAL;
...
public class StaticInsulinSensivityCalculator {
    ...
    public List<VaultEntry> calculateFromDataAsValutEntry(List<VaultEntry> data) {
        ...
        VaultEntryTypeFilter eventFilter = new VaultEntryTypeFilter(new VaultEntryTypeFilterOption(type));
        ...
        for (Pair<Date, Date> date : bolusEvents.timeSeries) {
            DateTimePointFilter filter = new DateTimePointFilter(new DateTimePointFilterOption(date.getKey(), (int) options.observationRange));
