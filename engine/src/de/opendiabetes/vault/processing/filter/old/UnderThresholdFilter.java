 ...
 * @author AChikhale
 */
public class UnderThresholdFilter implements Filter_old {
...
// GenericType I am taking it as package de.jhit.opendiabetes.vault.container.VaultEntry as private VaultEntryType type;
    ...
    public UnderThresholdFilter(VaultEntryType GenericType, Double thresholdValue, FilterType_old availabledatatype, FilterType_old TH) {
